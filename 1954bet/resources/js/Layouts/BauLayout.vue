<template>
    <div class="ml-0 md:ml-0 w-full max-w-[490px]" :class="'mb-[0px]'">
...
import NavBarInfos from '@/Components/Nav/NavBarInfos.vue';

export default {
    props: [],
    components: {CookiesComponent, BottomNavComponent, NavBarInfos},
    data() {
        return {
