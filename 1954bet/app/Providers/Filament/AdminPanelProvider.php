                ...
                return $builder->groups([
                    NavigationGroup::make()
                        ->items([
                            ...
                            ...AproveSaveSettingResource::getNavigationItems(),

                        ])
                     ,
                    auth()->user()->hasRole('admin') ?
                    NavigationGroup::make('Tabelas Historico Games')
                        ->items([
                            // ...MissionResource::getNavigationItems(),
                            ...GGRGamesResource::getNavigationItems(),
                    ...
                    NavigationGroup::make('Pagamentos, Usúarios e +')
                        ->items([
                            ...
                            ...AffiliateHistoryResource::getNavigationItems(),

                        ])
                    : NavigationGroup::make()
                    ,
                    auth()->user()->hasRole('admin') ?
                    NavigationGroup::make('Modulos, Vip, Missão e +')
                        ->items([
                            // ...MissionResource::getNavigationItems(),
                            ...VipResource::getNavigationItems(),
                            ...MissionDepositResource::getNavigationItems(),
                            ...PostNotificationResource::getNavigationItems(),
                            ...SliderTextResource::getNavigationItems(),
                            ...PlataEventosResource::getNavigationItems(),
                        ])
                    : NavigationGroup::make()
                    ,
                    auth()->user()->hasRole('admin') ?
                    NavigationGroup::make('Jogos, Categorias e Provedores')
                        ->items([
