...
trait EvergameTrait
{
    ...
    protected static $agentToken2;
    protected static $agentSecretKey2;
    protected static $apiEndpoint2;
    ...
    public static function getCredentialsEvergame(): bool
    {
        ...
        self::$agentToken2       = $setting->getAttributes()['evergame_agent_token2'];
        self::$agentSecretKey2       = $setting->getAttributes()['evergame_secret_key2'];
        self::$apiEndpoint2      = $setting->getAttributes()['evergame_api_endpoint2'];
     ...
     public static function GameLaunchEvergame($provider_code, $game_code, $lang, $userId)
    {
        if (self::getCredentialsEvergame()) {
            ...
            $endpointwo = "https://api.softapi.site/api/v1/game_launch";
            ...
            if (
                ...
                $postArray = [
                    "agentToken" => self::$agentToken2,
                    "secretKey" =>  self::$agentSecretKey2,
                    "user_code" => $userId . '',
